...
execute 'jboss' do
    ...
    cwd '/opt'
    #command "wget download.jboss.org/jbossas/7.1/jboss-as-7.1.1.Final/jboss-as-7.1.1.Final.zip"
    command 'unzip jboss-as-7.1.1.Final.zip -d /opt'
    command 'chown -R jboss. /opt/jboss-as-7.1.1.Final' 
...
template "/opt/jboss-as-7.1.1.Final/standalone/deployments/hudson.xml" do
  source "hudson.erb"
  mode '0755'
  variables ({
